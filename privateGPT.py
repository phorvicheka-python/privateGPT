    ...
    match model_type:
        case "LlamaCpp":
            llm = LlamaCpp(
                ...
                # n_gqa=8, # add this line for llma 70b
                n_ctx=model_n_ctx,
            ...
            # llm = LlamaCpp(model_path=model_path, n_gqa=8, n_gpu_layers=20, n_threads=14, n_ctx=2048, max_tokens=model_n_ctx, n_batch=model_n_batch, callbacks=callbacks, verbose=False)
        case "GPT4All":
            llm = GPT4All(
                model=model_path,
                max_tokens=model_n_ctx,
